...
- [高性能、高可靠、高扩展性：项目设计与证据](./project-quality-attributes.md)

SOC、海外支付、全球订阅、道路运输/CBT-I 和 AI Coding 页面开篇均新增三项能力总览，覆盖设计机制、成本取舍、故障恢复、扩展路径与追问。新增算例属于教学假设，不能直接作为个人项目业绩。
...
先读对应 canonical 原理专题，再用项目页组织事实、约束、失败分支、指标证据和演进取舍。所有方括号参数和候选人指标都应在面试前完成事实核验。

## 架构决策专项

[八道 P7/P8 架构决策实战题](./p7-p8-architecture-decision-workshop.md)：容量推导、重试预算、跨系统恢复、RAG 发布、多租户隔离、SLO、平台化与技术债排序。每题区分标准回答、深挖回答和验收证据。
