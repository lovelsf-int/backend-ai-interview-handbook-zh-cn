---
title: "AI 系统设计专题：从生产级架构到安全、可观测与语音 Agent · 学习版"
description: "AI 系统设计导览：许可正文与个人复习"
status: "reviewing"
...
source_blob: "d4ec81cdc458e24903689b0694c5b0d5eb71587a"
source_url: "https://javaguide.cn/ai/system-design/"
---

# AI 系统设计专题：从生产级架构到安全、可观测与语音 Agent

> 来源：JavaGuide / Guide 与原贡献者。[原文](https://javaguide.cn/ai/system-design/) · [固定源码](https://github.com/Snailclimb/JavaGuide/blob/d76264cb4e000416c4adca06770ce014bd309150/docs/ai/system-design/README.md) · [Apache-2.0 与修改说明](/ai-study/sources.md)。本站于 2026-09-09 增加学习卡并适配排版、链接与媒体引用。
...
1. [AI 应用系统设计](/ai-study/java-guide/system-design/ai-application-architecture.md)：先看 Prompt Demo 进入生产链路时，需要补哪些后端能力。
2. [LLM/Agent 安全实战](/ai-study/java-guide/system-design/llm-security.md)：沿一次工具调用理解直接与间接 Prompt Injection、资源鉴权、审批、MCP 授权、隔离和安全回归。
3. [大模型网关详解](/ai-study/java-guide/system-design/llm-gateway.md)：再看模型调用治理，多模型路由、fallback、限流和成本归因怎么放在网关层处理。
4. [AI 可观测性与 Trace](/ai-study/java-guide/system-design/ai-observability.md)：沿一次错误回答还原模型、RAG、工具和 Agent 的执行过程，再看上下文传播、采样和评测回流。
5. [AI 语音技术详解](/ai-study/java-guide/system-design/ai-voice.md)：最后看语音 Agent，从 VAD、ASR 到 LLM、TTS、播放和打断处理。

## 核心文章

- [AI 应用系统设计](/ai-study/java-guide/system-design/ai-application-architecture.md)：从 Prompt 管理讲到模型网关、RAG、Memory、Tool 调用、异步任务、可观测、评测和安全合规，适合作为系统设计主线。
- [LLM/Agent 安全实战](/ai-study/java-guide/system-design/llm-security.md)：通过售后退款 Agent 串联间接 Prompt Injection、工具越权、MCP 授权、敏感数据、代码隔离、供应链和安全评测。
- [大模型网关详解](/ai-study/java-guide/system-design/llm-gateway.md)：说明 LLM Gateway 在模型路由、fallback、限流配额、Token 预算、成本归因、观测审计和缓存策略中的职责。
- [AI 可观测性与 Trace](/ai-study/java-guide/system-design/ai-observability.md)：讲清 Session、Run、Trace、Span 和 Attempt，并覆盖 Agent/RAG/Tool Span、上下文传播、采样、敏感数据与 Spring AI 接入。
- [AI 语音技术详解](/ai-study/java-guide/system-design/ai-voice.md)：沿语音系统链路展开 VAD、ASR、LLM、TTS、流式播放、打断处理与端云混合选型。
