...
1. [缓存一致性与二级缓存](./05-cache-consistency.md)
2. [缓存穿透、击穿与雪崩](./06-penetration-breakdown-avalanche.md)

## 高可用与集群

1. [主从复制与 Sentinel](./07-replication-sentinel.md)
2. [Redis Cluster 与哈希槽](./08-cluster.md)

## 事务与分布式

1. [事务、Lua 与 Functions](./09-transactions-lua-functions.md)
2. [Redisson、分布式锁与 Fencing Token](./10-redisson-fencing-token.md)

## 生产排障与题库

1. [BigKey、HotKey 与阻塞事件](./11-bigkey-hotkey-incidents.md)
2. [面试速答与故障排查](./12-interview-troubleshooting.md)
